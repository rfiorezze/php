...
<div id="conteudo">
	...
	<p>
	<form action="AlterarJogador2.php">
		<input type="hidden" name="CPF" value="<?php echo $CPF ?>">
		Nome: <input type="text" name="Nome" value="<?php echo $Nome ?>"><br><br>	
		Função: <input type="text" name="Funcao" value="<?php echo $Funcao ?>"><br><br>
		...
		Data de Nascimento: <input type="text" name="DataNasc" value="<?php echo $DataNasc ?>"><br><br>
		Sigla da Equipe: <input type="text" name="SiglaEquipe" value="<?php echo $SiglaEquipe ?>"><br><br>
		CPF Treinador: <input type="text" name="CPF_Treinador" value="<?php echo $CPF_Treinador ?>"><br>
